...
**
** Created: Sun Jun 1 19:23:28 2014
...
static const char qt_meta_stringdata_MyLabel[] = {
    "MyLabel\0\0n\0numUn(int)\0numDos(int)\0"
    "numTres(int)\0Ok()\0"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->numUn((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->numDos((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->numTres((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->Ok(); break;
        default: ;
        }
    }
